...
dropdown.empty();
dropdown.append('<option selected="true" disabled>Escolha o Estado dos EUA</option>');
...
function clearCountyDropdown() {
	...
	countyDropdown.append('<option selected="true" disabled>Escolha a cidade</option>');
...
function loadChart(confirmed, deaths, state) {
	var chart = new CanvasJS.Chart("chartContainer", {
		title:{
			text: "COVID-19 casos confirmados ao longo do tempo para " + state.toUpperCase()              
		},
		axisY: {
